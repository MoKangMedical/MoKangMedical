...
本文档描述了MoKangMedical项目的API接口规范和使用方法。
...
```bash
# 克隆仓库
git clone https://github.com/MoKangMedical/MoKangMedical.git
cd MoKangMedical
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('/var/log/MoKangMedical/app.log'),
...
- 项目主页: https://github.com/MoKangMedical/MoKangMedical
